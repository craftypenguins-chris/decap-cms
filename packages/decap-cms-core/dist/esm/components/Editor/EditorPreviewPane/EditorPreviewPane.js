    ...
    try {
      ...
      if (isLocalBackend) {
        ...
        if (typeof window !== 'undefined' && window.console) {
          try {
            console.log('[local_backend preview] url:', {
              section,
              slug,
              path,
              previewUrl
